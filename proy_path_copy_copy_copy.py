...
class GoToGoal(Node):
    def __init__(self, points):
        ...
        notes_data = [(523, 0.2), (523, 0.2), (523, 0.2), (523, 0.5), (415, 0.5), (466, 0.5), (523, 0.3), (466, 0.2), (523, 1)]# Frecuencia y duración (segundos) para la nota
    ...
    def go_to_goal(self):
        ...
        if self.current_goal_index >= len(self.path):
            ...
            if any(lectura > 600 for lectura in self.ir): 
                new_vel.linear.x = 0.0
                new_vel.angular.z = 0.0
